    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5><i class="fas fa-plus"></i> Buat Quiz Baru</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="target_role" class="form-select @error('target_role') is-invalid @enderror" required>
                                    ...
                                    <option value="pelajar" {{ old('target_role') === 'pelajar' ? 'selected' : '' }}>Pelajar</option>
                                    <option value="masyarakat" {{ old('target_role') === 'masyarakat' ? 'selected' : '' }}>Masyarakat</option>
                                </select>
                                @error('target_role')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="time_limit" class="form-control @error('time_limit') is-invalid @enderror" 
                                       value="{{ old('time_limit', 30) }}" min="5" max="180" required>
                                @error('time_limit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
